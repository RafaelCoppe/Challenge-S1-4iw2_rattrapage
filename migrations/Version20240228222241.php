 ...
 */
final class Version20240228222241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT NOT NULL, terms VARCHAR(255) NOT NULL, payment_lastname VARCHAR(255) NOT NULL, payment_firstname VARCHAR(255) NOT NULL, payment_email VARCHAR(255) NOT NULL, payment_phone VARCHAR(255) NOT NULL, payment_address VARCHAR(255) NOT NULL, payment_city INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE line (id INT NOT NULL, product_id INT DEFAULT NULL, quote_id INT NOT NULL, place INT NOT NULL, unit_price DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, additional VARCHAR(255) NOT NULL, tax DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE member (id INT NOT NULL, username VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city INT NOT NULL, roles JSON NOT NULL, create_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, update_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, delete_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_70E4FA78F85E0677 ON member (username)');
        $this->addSql('CREATE TABLE member_agency (member_id INT NOT NULL, agency_id INT NOT NULL, PRIMARY KEY(member_id, agency_id))');
        $this->addSql('CREATE INDEX IDX_541644D57597D3FE ON member_agency (member_id)');
        $this->addSql('CREATE INDEX IDX_541644D5CDEADB2A ON member_agency (agency_id)');
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, agency_id INT NOT NULL, label VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE member_agency ADD CONSTRAINT FK_541644D57597D3FE FOREIGN KEY (member_id) REFERENCES member (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE member_agency ADD CONSTRAINT FK_541644D5CDEADB2A FOREIGN KEY (agency_id) REFERENCES agency (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE member_agency DROP CONSTRAINT FK_541644D57597D3FE');
        $this->addSql('ALTER TABLE member_agency DROP CONSTRAINT FK_541644D5CDEADB2A');
        ...
        $this->addSql('DROP TABLE member_agency');
